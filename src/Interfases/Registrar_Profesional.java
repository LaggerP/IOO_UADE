...
public class Registrar_Profesional extends JFrame {
	...
	public Registrar_Profesional() {
		...
		JButton btnCrearProfesional = new JButton("CREAR PROFESIONAL");
		btnCrearProfesional.setBounds(117, 232, 162, 21);
		contentPane.add(btnCrearProfesional);
